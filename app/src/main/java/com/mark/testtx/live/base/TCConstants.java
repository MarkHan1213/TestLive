package com.mark.testtx.live.base;
...
public class TCConstants {
    ...
    //云通信服务相关配置
    public static final int IMSDK_ACCOUNT_TYPE = 12217;
    public static final int IMSDK_APPID = 1400028912;

    //COS存储服务相关配置
    public static final String COS_BUCKET = "djlive";
    public static final String COS_APPID = "1253521423";
    ...
    public static final COSEndPoint COS_REGION = COSEndPoint.COS_TJ;

    //云API服务密钥，在https://console.qcloud.com/capi查看，用于UGC短视频上传并落地到点播系统。
    public static final String CLOUD_API_SECRETID = "AKIDXRM7mH5jgRzMXVrqCMOEwVu6B3lH3r16";

    //业务Server的Http配置
    public static final String SVR_POST_URL = "http://vod.zfwx.com/interface.php";
    ...
    //小直播appid
//    public static final int XIAOZHIBO_APPID = 1252463788;
    public static final int XIAOZHIBO_APPID = 1253521423;
