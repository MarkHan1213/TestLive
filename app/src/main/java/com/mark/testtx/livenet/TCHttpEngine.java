package com.mark.testtx.livenet;
...
//            = MediaType.parse("application/json; charset=utf-8");
     ...
     */
    public void post(final JSONObject req, final Listener listener) {
...
//                                }.getType());
                        HashMap<String, String> result = (HashMap<String, String>) JSON.parse(response.data);
//                        HashMap<String,String> result = new JSONObject().
